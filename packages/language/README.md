...
- [src/snakeskin.langium](src/snakeskin.langium) -  The grammar definition of your language
- [src/snakeskin-module.ts](src/snakeskin-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/snakeskin-validator.ts](src/snakeskin-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/snakeskin.monarch.ts](src/syntaxes/snakeskin.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/snakeskin.tmLanguage.json](syntaxes/snakeskin.tmLanguage.json) - Textmate based syntax highlighting instructions.
